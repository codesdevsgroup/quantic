...
<!-- <div class="modal fade" id="blackFridayModal" tabindex="-1" aria-labelledby="blackFridayModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="blackFridayModalLabel">Black Friday</h5>
        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/Logo-HD-Quantic-3D-Letra-Branca.png"  class="p-2 img-fluid" alt="Imagem Black Friday" width="230" height="auto">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body text-center m-auto">
        <div class="grid_text_modalbf">
          <p>
            Na <span>Black Friday</span> da <span>Quantic 3D</span>, estamos elevando a impressão 3D a um novo patamar! 
          </p>
        </div>
        <div class="grid_text_modalbf">
          <p>
            Aproveite o desenvolvimento <span>GRATUITO</span> do seu <span>projeto 3D</span> e pague apenas pela impressão.
          </p>
        </div>
        <div class="grid_text_modalbf">
          <p>
            Isso mesmo, <span>projetamos para você</span>, e você só paga pela <span>transformação</span> da ideia em realidade!
          </p>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-primary"><a href="./index.php/form/">Saiba Mais</a></button>
      </div>
    </div>
  </div>
</div> -->